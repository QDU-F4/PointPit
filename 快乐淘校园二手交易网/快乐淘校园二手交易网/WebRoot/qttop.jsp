...
width=183></TD>
        ...
        <TR>
          ...
          <TD vAlign=center align=middle><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="red">
           <tr>
              ...
              <td align="center"><strong><a href="shangpinxinxilist.jsp"><font  class="STYLE1">商品信息</font></a></strong></td>
  ...
  <TR>
    ...
    <TD height=147 background="qtimages/banner.jpg"><table width="48%" height="51" border="0" align="left">
      <tr>
        <td><div style="font-family:宋体; color:#FFFFFF; WIDTH: 100%; FONT-WEIGHT: bold; FONT-SIZE: 35px; margin-top:5pt">
            <div align="center" >快乐淘校园二手交易网</div>
        </div></td>
      </tr>
    </table></TD>
  ...
  <TR>
    ...
    <TD style="BACKGROUND-IMAGE: url(qtimages/B0084.gif)">
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        ...
        <TBODY>
        <TR>
          <TD width=71 height="40" align=middle style="color: #000000">站内搜索</TD>
          ...
          <TD width=341><span style="color: #000000">关键字</span>：
<input 
