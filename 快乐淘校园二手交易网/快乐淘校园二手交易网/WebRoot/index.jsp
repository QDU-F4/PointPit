            ...
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR>
                <TD width=50 height=40><IMG height=35 
                  ...
                  width=30></TD>
                <TD width=817><a href="news.jsp?lb=站内新闻"><span class="red"><strong>站内新闻</strong></span></a></TD>
            ...
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR>
                <TD width=44 height=40><IMG height=35 alt="" 
                  ...
                  width=32></TD>
                <TD width="487" class="red"><strong>商品信息</strong></TD>
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
          ...
          <TD class=int20>
		   ...
		   <div id="demo"  style="float:left; overflow:hidden">
				...
				<table width="100%" height="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                      <%
        for(HashMap m:new CommDAO().select("select * from shangpinxinxi order by id desc",1,8)){
         %>
	    <td align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0" id="product">
	        <tr align="center">
              ...
              <a href="shangpinxinxidetail.jsp?id=<%=m.get("id") %>" target=""><img src="<%=m.get("tupian") %>" border="0" title="<%=m.get("shangpinmingcheng") %>"  height="120" width="150"/></a></div></td>
	        </tr>
	        <tr align="center">
	          <td ><a href="" 
	          			target="">
	          		<%=m.get("shangpinmingcheng") %>
	          	</a></td>
	        </tr>
