...
//txixixngdy
    ...
    String url = "shangpinxinxi_list2.jsp?1=1"; 
    String sql =  "select * from shangpinxinxi where faburen='"+request.getSession().getAttribute("username")+"' ";
...
//youzuiping2
 ...
 <td><%=map.get("faburen") %></td>
    ...
    <td width="60" align="center"><a href="shangpinxinxi_updt.jsp?id=<%=map.get("id")%>">修改</a>  <a href="shangpinxinxi_list2.jsp?scid=<%=map.get("id") %>" onclick="return confirm('真的要删除？')">删除</a> <a href="shangpinxinxidetail.jsp?id=<%=map.get("id")%>" target="_blank">详细</a> </td>
  </tr>
  	<%
  }
   %>
